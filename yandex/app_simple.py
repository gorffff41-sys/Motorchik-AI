...
def generate_simple_response(message):
    """Простая генерация ответа без Yandex GPT"""
    responses = {
        'привет': 'Привет! Как дела?',
        'как дела': 'Отлично, спасибо! А у вас как?',
        'что ты умеешь': 'Я умею многое! Могу рассказать погоду, новости, искать в Wikipedia, считать, конвертировать валюты и переводить слова.',
    ...
    return "Извините, я пока не понимаю это сообщение. Попробуйте спросить о погоде, новостях или других доступных функциях!"
...
def process_message(message):
    ...
    # Обычный запрос к простому боту
    return {
        'type': 'gpt',
        'content': None,
        'message': None
